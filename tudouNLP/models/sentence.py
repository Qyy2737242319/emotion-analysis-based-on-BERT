...
flags.DEFINE_string(
    "bert_config_file", "./tudouNLP/models/bert_config.json",#此处绝对路径为工程文件夹最上层路径，故相对路径也不一样
    "The config json file corresponding to the pre-trained BERT model. "
    "This specifies the model architecture.")

flags.DEFINE_string("task_name", "classify", "The name of the task to train.")
...
def create_model(bert_config, is_training, input_ids, input_mask, segment_ids,
    ...
    hidden_size = output_layer.shape[-1]#返回值为int，output_layer.shape[-1].value改为output_layer.shape[-1]
